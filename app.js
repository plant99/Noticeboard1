...
var moderationHandler = require('./routes/moderationHandler')
...
app.use('/moderation', moderationHandler)
app.get('/noticeImage/:name', function(req,res){
  res.sendFile(__dirname+'/usersImage/'+req.params.name)
})
